      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            The comprehensive recruitment platform connecting employers and
            recruitment partners for seamless talent acquisition and candidate
            management.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 text-sm">
                Browse opportunities, manage candidates, and build successful
                placements.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 text-sm">
                Advanced security features with streamlined workflows for
